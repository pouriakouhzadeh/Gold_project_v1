...
def main() -> None:
    ...
    LOG.info("Model loaded: window=%d neg_thr=%.3f pos_thr=%.3f cols=%d",
    ...
    prep = PREPARE_DATA_FOR_TRAIN(
        ...
        main_timeframe="30T",
        verbose=False,
        fast_mode=True,         # برای دپلوی معمولاً سریع
    ...
    LOG.info("=== Deploy started (next-candle logic) ===")
    ...
    for _ in range(args.max_steps):
        ...
        LOG.info(
            ...
            ts_now, ts_feat, action, prob, cover_cum,
        )
